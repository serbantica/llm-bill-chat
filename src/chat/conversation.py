...
class Conversation:
    ...
    def generate_response(self, query):
        ...
        return "I'm sorry, I can only assist with bill-related queries. Please ask about your telecom bills."

    def get_bill_info(self):
        bills = self.user_info.get_bills()
        if len(bills) < 4:
            return "I need at least 4 bills to provide a comprehensive comparison."
    ...
    def compare_bills(self, last_four_bills):
        ...
        return f"Analyzing and comparing your last four bills: {last_four_bills}"